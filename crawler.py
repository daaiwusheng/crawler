...
class CrawlSelenium:
    ...
    def crawl(self, keywords, number_imgs=10):
        ...
        webdriver.ActionChains(self.driver).move_to_element(search_input).send_keys(keywords + Keys.ENTER).perform()
